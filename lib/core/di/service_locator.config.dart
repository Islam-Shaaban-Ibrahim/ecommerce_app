...
import '../../features/auth/presentation/cubit/auth_cubit.dart' as _i28;
...
import '../../features/cart/domain/use_cases/get_cart.dart' as _i32;
import '../../features/cart/domain/use_cases/remove_from_cart.dart' as _i27;
import '../../features/cart/domain/use_cases/update_cart.dart' as _i26;
...
import '../../features/home/domain/use_cases/get_brands.dart' as _i29;
import '../../features/home/domain/use_cases/get_categories.dart' as _i30;
...
import '../../features/products/domain/repository/products_repository.dart'
    as _i17;
import '../../features/products/domain/use_cases/get_products.dart' as _i31;
import '../../features/products/presentation/cubit/products_cubit.dart' as _i35;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i26.UpdateCart>(
        () => _i26.UpdateCart(gh<_i19.CartRepository>()));
    gh.singleton<_i27.RemoveFromCart>(
        () => _i27.RemoveFromCart(gh<_i19.CartRepository>()));
    gh.singleton<_i28.AuthCubit>(() => _i28.AuthCubit(
          gh<_i23.Login>(),
          gh<_i24.Register>(),
        ));
    gh.singleton<_i29.GetBrands>(
        () => _i29.GetBrands(gh<_i15.HomeRepository>()));
    gh.singleton<_i30.GetCategories>(
        () => _i30.GetCategories(gh<_i15.HomeRepository>()));
    gh.singleton<_i31.GetProducts>(
        () => _i31.GetProducts(gh<_i17.ProductsRepository>()));
    gh.singleton<_i32.GetCart>(() => _i32.GetCart(gh<_i19.CartRepository>()));
    ...
    gh.singleton<_i35.ProductsCubit>(
        () => _i35.ProductsCubit(gh<_i31.GetProducts>()));
    return this;
  }
}
